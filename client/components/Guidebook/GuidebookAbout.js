  ...
  render() {
    return (
      <div className={s.body}>
        ...
        <p>This application uses the CREST market API to pull market orders every 5 minutes, crunch all of the data, and deliver it to your client in the form of realtime charts and updated order tables. We do all of the heavy lifting so that all you have to do is watch the charts and update your orders. We then track your sales and provide data on overall profitability and trading performance.</p>
      </div>
    );
  }
}
