  ...
  render() {
    return (
      <div className={s.body}>
        ...
        <p>EVE Exchange utilizes the CREST market API at 5 minute intervals in order to have the most up-to-date information possible. We calculate buy/sell/margin/volume data in that 5 minute time span and deliver it to every connected client in real time.</p>
