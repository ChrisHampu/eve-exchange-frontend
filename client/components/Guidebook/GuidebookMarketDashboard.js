  ...
  render() {
    return (
      <div className={s.body}>
        ...
        <p>Your dashboard can be personalized to display multiple charts that you can view to quickly see the prices for your most important items. These charts also update in realtime, and can be used as shortcuts to view the item in the market browser to quickly see market orders.</p>
