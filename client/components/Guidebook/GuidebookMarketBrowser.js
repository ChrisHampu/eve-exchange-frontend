  ...
  render() {
    return (
      <div className={s.body}>
        ...
        <h3>Charts</h3>
        <p>Charts can be zoomed, scrolled, <span className={s.link} onClick={()=>this.setRoute("/dashboard/reference/settings")}>customized</span>, and changed to show different timespans. Currently the following timespans are supported:</p>
        <ul>
          <li><b>5 Minutes:</b> Premium only. Shows 5 minute intervals of the past 24 hours</li>
        ...
        <h3>Price Ladder</h3>
        <p>The price ladder shows all availabe buy & sell orders as well as which are within the top 5% respectively. Additionally, it will highlight the orders that belong to any of your profiles in the price ladder.</p>
