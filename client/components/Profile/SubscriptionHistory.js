...
import { formatNumber, prettyDate } from '../../utilities';
...
export default class SubscriptionHistory extends React.Component {
  ...
  render() {
    ...
    if (this.props.subscription.history && this.props.subscription.history.length) {
                    ...
                    history.map((el, i) => {
                      return (
                        <TableRow key={i} selectable={false}>
                          <TableRowColumn>{prettyDate(el.time)}</TableRowColumn>
